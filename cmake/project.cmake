...
set(C_SPEC_FLAG "-std=c11")
set(CXX_SPEC_FLAG "-std=c++14")

set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wall -Wextra ${TARGET_FLAGS} ${ADDITIONAL_C_FLAGS} ${C_SPEC_FLAG} -g" CACHE INTERNAL "c compiler flags")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wall -Wextra ${TARGET_FLAGS} ${ADDITIONAL_CXX_FLAGS} ${CXX_SPEC_FLAG} -g" CACHE INTERNAL "cxx compiler flags")
